...
foco em **Business Understanding**. Preenchidos apenas os blocos relevantes para este projeto —
...
- **[fedmml-ed-triage](https://huggingface.co/datasets/olaflaitinen/fedmml-ed-triage)**
  ...
  de pronto-socorro, licença CC BY 4.0. Escolhido em [ADR-001](decisions/ADR-001-dataset.md) por já
